...
sortSetButton.addEventListener("click", function() {
    ...
    if (counterDown !== 0) {
        ...
        showText(minifigNames[minifiglocations.indexOf(minifigImage.src)], "minifigName")
...
const removeInline = () => {
    let minifigImage = document.getElementById("minifigImage");
    let inlineImage = document.getElementById(minifiglocations.indexOf(minifigImage.src));
